...
public class NumberGameTest {
    ...
    @Test
    void should_return_数字_given_输入数字_when_运行() throws Exception {
        // 1 Given
        int number = 1;
        // 2 When
    ...
    @Test
    void should_return_数字2_given_输入数字2_when_运行() throws Exception {
        Assertions.assertEquals("2", new GameNumber(2).execute());
    }

    @Test
    void should_return_Fizz_given_被3整除_when_运行() throws Exception {
        Assertions.assertEquals("Fizz", new GameNumber(3).execute());
        Assertions.assertEquals("Fizz", new GameNumber(6).execute());
    }

    @Test
    void should_return_Fizz_given_包含3_when_运行() throws Exception {
        Assertions.assertEquals("Fizz", new GameNumber(13).execute());
    }

    @Test
    void should_return_Buzz_given_被5整除_when_运行() throws Exception {
    ...
    @Test
    void should_return_Buzz_given_包含5_when_运行() throws Exception {
        Assertions.assertEquals("Buzz", new GameNumber(58).execute());
    }

    @Test
    void should_return_FizzBuzz_given_同时被3和5整除_when_运行() throws Exception {
        Assertions.assertEquals("FizzBuzz", new GameNumber(15).execute());
    }

    @Test
    void should_return_FizzBuzz_given_同时包含3和5_when_运行() throws Exception {
